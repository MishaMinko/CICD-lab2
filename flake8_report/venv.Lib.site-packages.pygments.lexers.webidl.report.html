...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pygments\lexers\webidl.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.lexers.webidl.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.lexers.webidl.source.html#l148">
                  <tt><i>148</i>             <span class="p">(</span><span class="sa">r</span><span class="s1">&#39;-?(?:(?:[0-9]+\.[0-9]*|[0-9]*\.[0-9]+)(?:[Ee][+-]?[0-9]+)?&#39;</span> <span class="o">+</span></tt>
               </a>
            </li>
            </ul>
         </li>
